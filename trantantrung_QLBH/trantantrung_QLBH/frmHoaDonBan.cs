...
namespace trantantrung_QLBH
{
    public partial class frmHoaDonBan : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (!Function.ChecKey(sql))
            {
                ...
                sql = "INSERT INTO HOADONBAN(MAHDBAN, MANV, NGAYBAN, MAKH, TONGTIEN) VALUES (N'" + txtMaHDBan.Text.Trim() + "',N'" + cboMaNhanVien.SelectedValue +
                   "','" + Ngay(dtpNgayBan.Value.ToString()) + "',N'" + cboMaKhach.SelectedValue + "'," + txtTongTien.Text + ")";
                Function.RunSQL(sql);
            }
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "Shop DENNI TRẦN";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "BÀ ĐIỂM - HÓC MÔN";
            exRange.Range["A3:B3"].MergeCells = true;
            exRange.Range["A3:B3"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A3:B3"].Value = "Điện thoại: (08)68241063";
